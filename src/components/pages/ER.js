  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-center  ">
        ...
        <input
          className=" w-56 mt-8 h-12 sm:w-96 rounded-lg bg-gray-700 border-blue-600 indent-4 text-white shadow-lg focus:outline-none focus:ring focus:ring-blue-600"
          type="text"
