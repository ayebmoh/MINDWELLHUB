  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-center  ">
        ...
        <input
          className="sm:w-96 mt-8 h-12 w-56 rounded-lg bg-gray-700 border-blue-600 indent-4 text-white shadow-lg focus:outline-none focus:ring focus:ring-blue-600"
          type="text"
